...
import { printWarehouseSlip, printTransferSlip } from "@/lib/print-utils"
...
import {
  ...
  Send, RefreshCw, FileSpreadsheet, Download, Printer
} from "lucide-react"
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1.5">
                            <span className="font-mono text-sm font-bold text-purple-600">{t.code || t.id}</span>
                ...
                <>
                  <DialogHeader>
                    <DialogTitle className="font-serif flex items-center gap-2">
                      <Repeat className="h-5 w-5 text-purple-600" /> Phiếu {selectedTransfer.code || selectedTransfer.id}
                    </DialogTitle>
                  </DialogHeader>
                  <div className="space-y-4">
                  ...
                  <DialogFooter>
                    <Button
                      ...
                      className="gap-1.5"
                      onClick={() => printTransferSlip({
                        code: selectedTransfer.code || selectedTransfer.id,
                        date: selectedTransfer.date,
                        fromWarehouse: selectedTransfer.fromWarehouse,
                        toWarehouse: selectedTransfer.toWarehouse,
                        reason: selectedTransfer.reason,
                        note: selectedTransfer.note,
                        status: selectedTransfer.status,
                        createdBy: selectedTransfer.createdBy,
                        pickupMethod: selectedTransfer.pickupMethod,
