...
import {
  ...
  ClipboardCheck, Repeat, Building2, QrCode, CalendarDays, Clock, ShieldCheck, Search
} from "lucide-react"
...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/employee/document-audit", icon: <Search className="h-5 w-5" />, label: "Rà soát mã phiếu" },
    ],
  },
  {
    label: "Đơn hàng",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/employee/court-services", icon: <Clock className="h-5 w-5" />, label: "Dịch vụ tại sân" },
