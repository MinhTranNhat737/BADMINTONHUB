  ...
  const handleAction = () => {
    ...
    if (actionType === "export") {
      ...
      exportTransferItems({
        ...
        qtys,
        date: today,
        note: `Xuất hàng điều chuyển ${actionTransfer.transferCode || actionTransfer.id} đến ${actionTransfer.toWarehouse}`,
        ...
        <CardContent className="p-0">
          <Table>
            ...
            <TableBody>
              ...
              {filtered.map(t => (
                <TableRow key={t.id}>
                  <TableCell className="font-mono text-xs text-purple-600">{t.transferCode || t.id}</TableCell>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div>
                  ...
                  <p className="font-mono font-medium text-purple-600">{actionTransfer.transferCode || actionTransfer.id}</p>
                </div>
                <div>
